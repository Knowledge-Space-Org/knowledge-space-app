...
const DATASPACE_SOURCES = {
  ...
  scr_017612_ebrains: {
    ...
    aggs: { 'sex.keyword': 'Sex', 'species.keyword': 'Species', 'techniques.keyword': 'Techniques', 'preparation.keyword' : 'Preparation', 'experimental_approach.keyword': 'Experimental Approach'}
  }
  }
